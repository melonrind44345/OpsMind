...
class CPUInfo(BaseModel):
    ...
    frequency_mhz: Optional[float] = Field(default=None, description="CPU frequency in MHz")
    flags: List[str] = Field(default_factory=list, description="CPU feature flags")
    cache_size_kb: Optional[int] = Field(default=None, description="CPU cache size in KB")
    virtualization: Optional[str] = Field(default=None, description="Virtualization type if applicable")
...
class MemoryInfo(BaseModel):
    ...
    memory_type: Optional[str] = Field(default=None, description="Memory type (DDR3, DDR4, etc.)")
...
class DiskInfo(BaseModel):
    ...
    is_ssd: Optional[bool] = Field(default=None, description="Whether the disk is an SSD")
...
class NetworkInterface(BaseModel):
    ...
    speed_mbps: Optional[int] = Field(default=None, description="Interface speed in Mbps")
...
class HardwareSpec(BaseModel):
    ...
    system_vendor: Optional[str] = Field(default=None, description="System vendor")
    system_model: Optional[str] = Field(default=None, description="System model")
    bios_version: Optional[str] = Field(default=None, description="BIOS version")
...
class SoftwarePackage(BaseModel):
    ...
    vendor: Optional[str] = Field(default=None, description="Package vendor/provider")
...
class ServiceInfo(BaseModel):
    ...
    load_state: Optional[str] = Field(default=None, description="Service load state")
...
class SoftwareEnvironment(BaseModel):
    ...
    run_level: Optional[str] = Field(default=None, description="System run level")
    selinux_enabled: Optional[bool] = Field(default=None, description="SELinux status")
    firewall_enabled: Optional[bool] = Field(default=None, description="Firewall status")
    hostname: str = Field(default="", description="System hostname")
...
class SecurityAssessment(BaseModel):
    ...
    selinux_enforcing: Optional[bool] = Field(default=None, description="Whether SELinux is enforcing")
    ...
    security_updates_count: Optional[int] = Field(default=None, description="Number of pending security updates")
...
class DiscoveryMetadata(BaseModel):
    ...
    data_size_bytes: Optional[int] = Field(default=None, description="Size of raw data collected")
